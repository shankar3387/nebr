...
import ChitBoard from "../ChitBoard/ChitBoard";
...
export default class Home extends React.Component {
  ...
  ChitBoard = [
    {
      ...
      name: "shree",
      datetime: "14 Aug 2020, 09:00 AM",
      title: "Food for better health",
      description: "hhh",
    },
    {
      ImageSrc: "images/4.jpg",
  ...
  chitList = this.ChitBoard.map((blogs) => <ChitBoard blogs={blogs} />);
        ...
        <div className="container pt-5">
                        ...
                        <span>
                          <small>
                            <span className="m-0 on_name">
                              <b>
                                Vaibhav Sharma Bought{" "}
                                <Link href>Casual Shirt</Link>
                              </b>
                            </span>
                          </small>
                          <br />
                          <small>
                            <span>8 Order placed out of 10 by 5 members</span>
                          </small>
                        </span>
                        <span>
                          <small className="text-warning">
                            14 aug 2020, 09:00 PM
                          </small>
                        </span>
                      </div>
                    </div>
                ...
                <div className="col-lg-12">
                  <div className="col-lg-12 bg-white shadow_box rounded">
                      ...
                      <div className="col-lg-8">
                        ...
                        <div className="form-check pt-2">
                          <label className="form-check-label">
                            ...
                            />
                            <small>
                              The moon in a Cancer will promote a feeling
                            </small>
                          </label>
                        </div>
                        <div className="form-check pt-2">
                          <label className="form-check-label">
                            ...
                            />
                            <small>
                              They motivated and inspiried you to handle the
                              project.
                            </small>
                          </label>
                        </div>
                        <div className="form-check pt-2">
                          <label className="form-check-label">
                            ...
                            />
                            <small>
                              You had been struggling withit for quite some
                            </small>
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="row py-2 d-flex justify-content-between">
                      <div className="col">
                        <button
                          className="btn btn-default bg-warning text-white mr-3 px-4"
                          type="button"
                        >
                          Submit
                        </button>
                      ...
                      <div className="col d-flex justify-content-end align-items-center">
                        <small>Want to create a poll like this? </small> &nbsp;
                        <CreatePollsButton />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-12 bg-white shadow_box rounded">
                    <div className="row rounded-top">
                      <div className="col-lg-12 rounded p-2">
                        <h6>Blog Board</h6>
                        <span className="poll_fa" style={{ top: 5, right: 8 }}>
                          <Link href>
                            <i
                              className="fa fa-long-arrow-right"
                              aria-hidden="true"
                    ...
                    <div className="row blog_board">{this.blogsList}</div>
                    <div className="row">
                      <CreateBlogsButton />
                    </div>
                  </div>
                ...
                <div className="col-lg-12 pr-0">
                  <div className="col-lg-12 bg-white shadow_box rounded">
                    ...
                    <div className="row chit_board">
                      <div className="col-lg-12 p-1">{this.chitList}</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="row pt-5">
            <div className="col-md-12">
              ...
              <button type="button" className="btn btn-primary mr-2 view_all">
                View All
              </button>
              <div className="row pt-4">{this.fashionList}</div>
            </div>
          </div>
          {/*///////////Fashion//////////-*/}
          {/*Featured Seller-*/}
                ...
                <div className="col-lg-3">
                  <div className="post-slide9">
                    ...
                    <div className="post-review">
                        ...
                        <li>
                          <div className="tooltip">
                            ...
                            <ul className="tooltiptext d-flex justify-content-around no-bullets">
                              ...
                              <li>
                                <Link href className="google_plus">
                                  <i
                      ...
                      <small>Mon - Fri, 09:00 AM to 09:00 PM</small>
                      <br />
                ...
                <div className="col-lg-3">
                  <div className="post-slide9">
                    <div className="rental-img">
                      ...
                      <ul
                        className="d-flex justify-content-end pr-2 pt-2 shopping_cart"
