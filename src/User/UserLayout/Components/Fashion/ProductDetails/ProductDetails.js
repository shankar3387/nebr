        ...
        <div className="wrapper row">
          <div className="preview col-md-4">
            <div className="preview-pic tab-content">
              <div className="tab-pane active" id="pic-1"><img src="images/banner2.png" /></div>
            ...
            <ul className="preview-thumbnail nav nav-tabs">
              <li className="active"><a data-target="#pic-1" data-toggle="tab"><img src="images/banner2.png" /></a></li>
          ...
          <div className="details col-md-8">
            ...
            <h4 className="product-title">Casual Shirt</h4>
            ...
            <ul className="no-bullets d-flex border_bottom pt-2 pb-2">
              <li className="pr-md-5"><h4><i className="fa fa-inr" />379</h4></li>
              <li className="ml-5">
