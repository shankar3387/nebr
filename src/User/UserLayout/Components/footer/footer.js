      ...
      <footer className="footer_section pt-5">
        ...
        <div className="container pb-5 pt-3">
          <div className="social-btns text-center">
            <a type="button" className="btn-floating btn-lg btn-insta">
              <i className="fa fa-instagram" />
            </a>
            <a type="button" className="btn-floating btn-lg btn-fb">
              <i className="fa fa-facebook" />
            </a>
            <a type="button" className="btn-floating btn-lg btn-tw">
              <i className="fa fa-twitter" />
            </a>
            <a type="button" className="btn-floating btn-lg btn-linkedin">
              <i className="fa fa-linkedin" />
            </a>
            <a type="button" className="btn-floating btn-lg btn-youtube">
