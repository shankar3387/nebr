        ...
        >
          ...
          <div className="container seller_account">
                        ...
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              ...
                              name="optradio"
                            />
                            <small>I'm a Community Member</small>
                          </label>
                        </div>
                      </li>
                      <li>
                        <div className="form-check ml-5">
                          <label className="form-check-label">
                            <input
                              ...
                              name="optradio"
                            />
                            <small>I'm not a Community Member</small>
                          </label>
                        </div>
                      </li>
                    </ul>
            ...
            <div className="row">
              <div className="col-lg-12">
                <button
                  className="btn btn-default bg-warning text-white"
                  type="button"
                >
                  SUBMIT
                </button>
                <button
                  className="btn btn-default bg-warning text-white ml-3"
                  type="button"
                >
                  CANCEL
                </button>
